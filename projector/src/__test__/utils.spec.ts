...
import { nodeSetByUid, Node, getGlobalNode, ensureGlobalNode, INodeRef } from "../node";
...
describe("utils", ()=> {
    ...
    it("node ArraySet works", ()=> {
        globalState.nodeMap = [];
        const nm = globalState.nodeMap;// [] as utils.ArraySet<Node>;
        ...
        expect(nodeSetByUid.count(nm)).toBe(8);
        for(let i = 5; i <= 8; i++) {
            expect(nodeSetByUid.remove(nm, i)).toEqual(new Node(i, globalState.baseChangeMap));
        }
        expect(nm.length).toBe(1 + 2 * 4);
        expect(nodeSetByUid.count(nm)).toBe(4);
        expect(nodeSetByUid.step(nm)).toBe(2);        
        // back to dense array
        expect(nodeSetByUid.remove(nm, 4)).toEqual(new Node(4, globalState.baseChangeMap));
        expect(nm.length).toBe(3);
        expect(nodeSetByUid.count(nm)).toBe(3);
        expect(nodeSetByUid.step(nm)).toBe(1);        
        expect(nm[0] as INodeRef).toBe(n2);
        expect(nm[1] as INodeRef).toBe(n1);
        expect(nm[2] as INodeRef).toEqual(new Node(3, globalState.baseChangeMap));
        for(let i = 4; i <= 8; i++) {
            const ni = ensureGlobalNode(i);
            expect(nm.length).toBe(i);
            expect(nodeSetByUid.count(nm)).toBe(i);
        ...
        expect(nodeSetByUid.remove(nm, 3)).toEqual(new Node(3, globalState.baseChangeMap));
        expect(nm.length).toBe(3);
        expect(nodeSetByUid.step(nm)).toBe(1);        
        expect(nm[0] as INodeRef).toBe(n2);
        expect(nm[1] as INodeRef).toBe(n1);
        expect(nm[2]).toEqual(new Node(4, globalState.baseChangeMap));
        ensureGlobalNode(3);
        for(let i = 5; i <= 8; i++) {
            const ni = ensureGlobalNode(i);
            expect(nm.length).toBe(i);
        ...
        expect(nodeSetByUid.remove(nm, 8)).toEqual(new Node(8, globalState.baseChangeMap));
        ...
        expect(nodeSetByUid.remove(nm, 5)).toEqual(new Node(5, globalState.baseChangeMap));
        expect(nodeSetByUid.remove(nm, 6)).toEqual(new Node(6, globalState.baseChangeMap));
        expect(nodeSetByUid.remove(nm, 7)).toEqual(new Node(7, globalState.baseChangeMap));
        ...
        expect(nodeSetByUid.remove(nm, 23)).toEqual(new Node(23, globalState.baseChangeMap));
        ...
        for(let i = 1; i <= 9; i++) {
            expect(nodeSetByUid.get(nm, i)).toEqual(new Node(i, globalState.baseChangeMap));
        }
        expect(getGlobalNode(1)).toBe(n1);
        expect(getGlobalNode(2)).toBe(n2);
        expect(getGlobalNode(9)).toBe(n9);
        expect(getGlobalNode(231)).toBe(n231);
        //expect(getGlobalNode(24)).toBe(n24);
        expect(getGlobalNode(23)).toEqual(new Node(23, globalState.baseChangeMap));
    ...
    xit("Old non-31bit Uid functions works", ()=> {
